...
Gem::Specification.new do |spec|
    spec.name          = "jekyll-theme-h2o-neo"
    spec.version       = "1.3.4"
    spec.authors       = ["neowc"]
    spec.email         = ["neo-wc@outlook.com"]
  
    spec.summary       = "A Jekyll theme for researchers and maintainers based on Jekyll and H2O theme."
    spec.homepage      = "https://github.com/neowc/jekyll-theme-H2O-neo"
    spec.license       = "MIT"
    ...
    spec.metadata = {
      "bug_tracker_uri"   => "https://github.com/neowc/jekyll-theme-H2O-neo/issues",
      "changelog_uri"     => "https://github.com/neowc/jekyll-theme-H2O-neo/tree/master/logs.md",
      "mailing_list_uri"  => "https://github.com/neowc/jekyll-theme-H2O-neo/discussions",
      "source_code_uri"   => "https://github.com/neowc/jekyll-theme-H2O-neo/tree/master",
