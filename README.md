...
``` git clone https://github.com/neowc/jekyll-theme-H2O.git ```
...
```
# Site settings
title: '梁炜昌的独立博客' # 你的博客网站标题
description: '很高兴能在这里与你分享我对技术和生活的思考。' # 站点描述
keyword: '梁炜昌, 梁炜昌的独立博客, 梁炜昌的博客, 后端, 后端开发, 后端博客' # 网站关键词
url: 'https://neowc.github.io' # 站点url
baseurl: ''
